                            ...
                            <div class="menu-wrap">
                                <nav class="menu-nav">
                                    ...
                                    <div class="header-action d-none d-md-block">
                                        <ul>
                                            <li class="header-btn"><a href="#" class="btn">Make An Schedule</a></li>
                                            <li class="header-search"><a href="#"><i class="flaticon-search-interface-symbol"></i></a></li>
                                            <li class="header-user"><a href="#"><i class="flaticon-user"></i></a></li>
                                            <li class="header-offcanvase"><a href="#"><i class="flaticon-dots-menu"></i></a></li>
                                        </ul>
                                    </div>
                                </nav>
                            </div>
